...
public class MyFirstObjectSpawner : MonoBehaviour
{
    ...
    private void SpawnObject()
    {
        ...
        GameObject newObject = Instantiate(newSpawnObject, new Vector3(gameObject.transform.position.x + randomStartPoint.x, gameObject.transform.position.y, gameObject.transform.position.z + randomStartPoint.y), gameObject.transform.rotation);
